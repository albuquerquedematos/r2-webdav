...
import { Drawer, IconButton, TextField, Box, Typography, Button } from '@mui/material'
	...
	return (
		<Drawer anchor='right' open={open} onClose={() => setOpen(false)}>
			<Box sx={{ width: 400, padding: 3 }}>
				...
				<TextField label='Note Title' fullWidth variant='outlined' margin='normal' value={noteTitle} onChange={(e) => setNoteTitle(e.target.value)} />
				...
				<Button variant='contained' startIcon={<SaveIcon />} fullWidth sx={{ mt: 2 }} onClick={handleSaveAndUpload}>
					Save & Upload
				</Button>
			</Box>
		</Drawer>
